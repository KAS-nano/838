...
- Recomendações passam a salvar até 10 cenários personalizados localmente e gerar links técnicos sem nome, hardware ou perfil.
- Dependabot deixa de propor ESLint/TypeScript majors incompatíveis com a cadeia atual do Next; versões suportadas foram restauradas no lockfile.
- Dependência direta zod sem uso removida; pngjs passa a ser dependência direta do teste de QR e decisões de persistência/preview ganham ADRs.
