...
| RUSTSEC-2025-0075, 0080, 0081, 0098, 0100 | família `unic` via `urlpattern`/Tauri | advisories de manutenção, sem falha explorável descrita | origem fixada, agente sem navegação externa e atualização via Dependabot | mantenedor do 838 | próxima atualização Tauri |
