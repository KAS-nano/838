...
for s in \
 ...
 scripts/stage20-check.sh scripts/stage21-check.sh scripts/stage22-check.mjs scripts/stage23-check.sh scripts/stage24-check.sh scripts/stage25-check.mjs scripts/stage26-check.sh scripts/stage27-check.sh scripts/stage28-check.sh scripts/stage29-check.sh scripts/stage30-check.sh scripts/stage31-check.py scripts/stage32-check.mjs scripts/stage33-check.mjs scripts/stage34-check.mjs scripts/stage35-check.mjs scripts/stage36-check.mjs scripts/stage37-check.mjs scripts/stage38-check.mjs scripts/artifact-checksums-test.mjs scripts/model-favorites-test.mjs scripts/comparison-storage-test.mjs scripts/named-comparisons-test.mjs scripts/stage39-check.mjs scripts/stage40-check.mjs scripts/stage41-check.mjs scripts/stage42-check.mjs scripts/stage43-check.sh scripts/comparison-engine-check.sh scripts/support-test.mjs scripts/frontend-engine-check.sh; do
  echo "===== $s ====="
