  ...
  return <main>
    <div className="page-container space-y-8">
      ...
      <section className="panel p-6 space-y-4">
        ...
        <ul className="grid gap-2 text-ink sm:grid-cols-2"><li>GPU, CPU e memória</li><li>Sistema operacional</li><li>Modelo e quantização</li><li>Runtime e backend</li><li>Contexto e tokens/s medidos</li><li>Pico de VRAM quando disponível</li></ul>
